...
class GoldTables():
    '''
    Class to gold tables
    '''

    def __init__(self, env: str) -> None:
        '''
        Initialize GoldTables class
    ...
    def gold_table(self, views: dict, bucket: str, path_to: str, table_to: str) -> list:
        '''
        Function to gold table
        ...
        try:
            ...
            fd = open(Path.joinpath(PROJECT_PATH, f"sql/gold_tables/{table_to}.sql"), 'r')
            sqlFile = fd.read()
            fd.close()
